        ...
        >
          <div class="repo-header">
            <div class="repo-title">
              ...
              <div class="repo-info">
                <h3>
                  <a :href="'https://github.com/' + repo.repo_name" target="_blank">
                    {{ repo.repo_name }}
                  </a>
                </h3>
          ...
          <div class="release-content">
            <h4>
              <a :href="repo.latest_release.html_url" target="_blank">
            ...
            <div class="release-footer">
              <el-button 
                type="text" 
                @click="openAllReleases(repo.latest_release.all_releases_url)"
              >
                查看所有版本
              </el-button>
            </div>
  ...
  methods: {
    ...
    async fetchReleases(forceRefresh = false) {
      try {
        ...
        // 创建 EventSource 连接
        const eventSource = new EventSource(`http://localhost:8000/api/starred-releases/progress?token=${this.accessToken}&force_refresh=${forceRefresh}`)
